...
abstract class News extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \app\modules\crud\models\query\NewsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\crud\models\query\NewsQuery(get_called_class());
    }
